(function($R) {
    ...
    {
        var names = ['url', 'text', 'target', 'title', 'aria'];
        var data = {};
    ...
    $R['classes']['link.component'].prototype._get_aria = function()
    {
        return this.attr('aria-label');
    };

    $R['classes']['link.component'].prototype._set_aria = function(aria)
    {
    ...
    $R['modals']['link'] = `
        <form action="">
            ...
            <div class="form-item form-item-aria">
                <label for="modal-link-aria">## aria ##</label>
                <input type="text" id="modal-link-aria" name="aria">
            </div>
    ...
    $R['modules']['link'].prototype._setLinkData = function(nodes, data, type)
    {
        ...
        for (var i = 0; i < nodes.length; i++)
        {
            ...
            if (data.aria !== undefined) linkData.aria = data.aria;
